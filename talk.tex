...
\begin{frame}{SUSY contribution -- $a_\mu^\text{SUSY,2L(b)}$}
  \begin{align*}
    a_\mu^\text{SUSY,2L(b)} =
    a_\mu^{\text{SUSY,2L,photonic}}
    + a_\mu^{\text{SUSY,2L},f/\tilde{f}}
    + a_\mu^{\text{SUSY,2L,rest}}
  \end{align*}
  \begin{align*}
    a_\mu^{\text{SUSY,2L,photonic}} &=
    \fmfvcenter{SUSY2Lbphotonic} = -(0.07\ldots 0.09) a_\mu^{\text{SUSY,1L}}
    \\[-2em]
    a_\mu^{\text{SUSY,2L},f/\tilde{f}} &= \fmfvcenter{SUSY2Lbfsf}
    \propto \log\frac{\MS}{m_\mu} < 0.1 a_\mu^{\text{SUSY,1L}}
    \\[-2em]
    a_\mu^{\text{SUSY,2L,rest}} &= \fmfvcenter{SUSY2Lbrest} = \text{unknown}, O(2\cdot 10^{-10})
  \end{align*}
\end{frame}

\begin{frame}{GM2Calc -- most precise MSSM calculation of $a_\mu^{\text{SUSY}}$}
  Implemented:
  Missing:
  Uncertainty:
  \begin{align*}
    \delta a_\mu^{\MSSM} = 2.3\cdot 10^{-10} + 0.3 \left( |a_\mu^{(\chi\gamma H)}| + |a_\mu^{(\tilde{f}\gamma H)}| \right)
  \end{align*}
\end{frame}
