...
\date{Mainz, 19.06.2017}

\institute[Aachen]{RWTH Aachen}
\keywords{LHC,muon,magnetic,moment,GM2Calc,FlexibleSUSY,FeynHiggs,supersymmetry}
...
\begin{frame}{Anomalous magnetic moment in QFT}
  ...
  \end{align*}
  in the limit of vanishing photon momentum, $q^2 \rightarrow 0$:
  \begin{align*}
...
\begin{frame}{SM contribution}
  \begin{align*}
    ...
    \amuhad &= (692.3(4.2)^{\text{LO}} + 0.7(2.6)^{\text{NLO}})\cdot 10^{-10}
    \text{\mycite{1010.4180,0901.0306}} \\
...
\begin{frame}{BSM contributions}
  ...
  \begin{centering}
    \begin{tcolorbox}[width=0.6\textwidth,colframe={red},colback={white}]
      \begin{equation*}
        a_\mu^\text{BSM} \propto C \frac{m_\mu^2}{M_\text{BSM}^2}
      \end{equation*}
    \end{tcolorbox}
  \end{centering}
  ...
  $C\propto \tan\beta$, $\log\left(\frac{M_\text{BSM}}{m_\mu}\right)$
\end{frame}
